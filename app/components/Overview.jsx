...
export default function Overview(params) {
  ...
  return (
    <>
        ...
        {banner.map((item) => {
          ...
          return (
            <div
              style={{
                // background: `url(${backgroundImageUrl})`,
                background: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${item})`,
                backgroundSize: "cover",
      ...
      <div class="scrolling-text" className="bg-black">
        <marquee behavior="scroll" direction="left" scrollamount="7">
          <a
            href="https://example.com"
            target="_blank"
            className={"text-white  animate-pulse animate-pling"}
          >
            Registration Date Extended till 15th
          </a>
        </marquee>
      </div>
    </>
